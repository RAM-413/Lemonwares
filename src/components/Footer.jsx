...
const Footer = () => {
    return (
        <>
            <div className='bg-red-700 overflow-hidden' id='contact'>
                <div className='max-w-[1244px] mx-auto px-3 md:py-[80px] sm:py-[50px] py-[40px]'>
                    <div className='flex flex-wrap flex-row -mx-3'>
                        <div className=' lg:w-1/3 w-full px-3' data- aos="fade-right">
                        ...
                        <div className='lg:w-2/3 w-full pt-10 px-3 lg:px-0' da ta-aos="fade-left">
                            <div className='flex flex-wrap flex-row -mx-3'>
                                <ul className='w-1/2 md:w-1/4 px-3'>
                                    ...
                                    <li className="pt-2 sm:pt-6"><a href="#" className='text-neutral-200 sm:text-base text-[14px] font-normal font-["Inter"] leading-loose after:duration-500 duration-300 hover:after:w-full after:w-0 after:absolute relative after:left-[50%] hover:after:left-0 after:bottom-[-4px]  after:h-[2px] after:rounded-full hover:after:bg-[#FFF] '>Domain</a></li>
                                ...
                                <ul className='w-1/2 md:w-1/4 px-3'>
                                    ...
                                    <li className="sm:pt-6 pt-2"><a href="#" className='text-neutral-200 sm:text-base text-[14px] font-normal font-["Inter"] leading-loose after:duration-500 duration-300 hover:after:w-full after:w-0 after:absolute relative after:left-[50%] hover:after:left-0 after:bottom-[-4px]  after:h-[2px] after:rounded-full hover:after:bg-[#FFF] '>Cheap Hosting</a></li>
